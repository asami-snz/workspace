package com.example.demo.com.example.demo.event.src;
...
import com.example.demo.com.example.demo.event.dao.EventService;
...
public class TopController {
	...
	@GetMapping("/eventSelectJoinComp")
	public String getEventSelectComp(Model model) {
	...
	// GetRequestでイベント作成完了画面をメイン部分に表示する
	@GetMapping("/eventRegisterComp")
	public String getEventRegisterComp(Model model) {
